...
import { HANDSHAKE_FINISH } from "../Utils/constants";
type HandSVGProps = {
  fillColour: string;
...
export const HandSVG = (props: HandSVGProps) => {
  ...
  if (props.handshakeProgress.get() > HANDSHAKE_FINISH) {
