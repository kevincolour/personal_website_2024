  ...
  return (
    <>
      ...
      <MyComponentWrapper transitionObj={{ delay: 10 }}>
        <div>
          People have said university is a scam plenty of times and I'm happy to
          disagree
        </div>
      </MyComponentWrapper>
      <MyComponentWrapper transitionObj={{ delay: 14 }}>
        <div>
          But there's no doubt that it's usually scammers that are usually the
          ones that employ tricks and employ deception
        </div>
      </MyComponentWrapper>
